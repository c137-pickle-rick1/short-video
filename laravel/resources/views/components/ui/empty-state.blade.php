@props([
  ...
  'buttonHref' => '',
  'buttonAttributes' => [],
  'containerClass' => 'flex min-h-[clamp(26rem,58vh,42rem)] w-full flex-col items-center justify-center px-6 py-12 text-center',
  'iconShellClass' => 'mx-auto flex items-center justify-center text-[4rem] text-gray-400',
  'titleClass' => 'mt-4 text-xl font-semibold tracking-tight text-gray-950 sm:text-2xl',
  'descriptionClass' => 'mt-4 mx-auto w-full max-w-xl text-sm leading-7 text-gray-500 sm:text-base',
  'buttonClass' => 'inline-flex h-11 items-center justify-center gap-2 rounded-full bg-gray-900 px-5 text-sm font-semibold text-white transition hover:bg-rose-600',
  'dataEmptyState' => false,
])
