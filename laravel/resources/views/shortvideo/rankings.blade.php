          ...
          <section class="min-w-0 flex-1">
            <div class="grid gap-5 lg:gap-6 xl:gap-7">
              <header class="rounded-[32px] border border-gray-200 bg-white px-5 py-6 shadow-sm sm:px-6 sm:py-7 lg:px-8 lg:py-8">
                <p class="text-sm font-semibold uppercase tracking-[0.18em] text-sky-600">{{ $page['eyebrow'] }}</p>
              ...
              <section class="rounded-[32px] border border-gray-200 bg-white px-4 py-4 shadow-sm sm:px-5 sm:py-5 lg:px-6 lg:py-6">
